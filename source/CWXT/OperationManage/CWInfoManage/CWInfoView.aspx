<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CWInfoView.aspx.cs" Inherits="CWXT.OperationManage.CWInfoManage.CWInfoView" %>
    ...
    <form id="Form1" method="post" runat="server">
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                <td>
                    <!--标题-->
                    <span class="txtPageTitle">查看村务信息</span></td>
                <td>
