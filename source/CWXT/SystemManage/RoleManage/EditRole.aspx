<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EditRole.aspx.cs" Inherits="CWXT.SystemManage.RoleManage.EditRole" %>
	...
	<body class="common">
		<form id="Form1" method="post" runat="server">
			<table cellpadding="0" cellspacing="0" border="0" width="100%">
				<tr>
					<td><!--标题--><span class="txtPageTitle">编辑用户组</span></td>
