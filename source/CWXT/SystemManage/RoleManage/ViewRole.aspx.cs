...
namespace CWXT.SystemManage.RoleManage
{
    ...
    /// ViewRole 的摘要说明。
    /// </summary>
    public partial class ViewRole : EnterpriseWebsite.WebUI.ScrollPage
    {
        protected void Page_Load(object sender, System.EventArgs e)
        {
            if (!this.IsPostBack)
            {
                ucRole.LoadData(this.PKID, Enums.PageStatus.View);
            }
        }
        ...
        {
            base.PageTransfer("EditRole.aspx", Enums.Constants.PKID + "=" + this.PKID.ToString());
            return false;
        }
