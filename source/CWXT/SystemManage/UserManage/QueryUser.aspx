<%@ Page Language="c#" CodeBehind="QueryUser.aspx.cs" AutoEventWireup="True" Inherits="CWXT.SystemManage.UserManage.QueryUser" %>
    ...
    <form id="Form1" method="post" runat="server">
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
            ...
            <tr>
                <td>
                    <!--标题-->
                    <span class="txtPageTitle">查询用户信息</span></td>
                <td>
