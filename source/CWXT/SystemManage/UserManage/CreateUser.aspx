<%@ Page Language="c#" CodeBehind="CreateUser.aspx.cs" AutoEventWireup="True" Inherits="CWXT.SystemManage.UserManage.CreateUser" %>
    ...
    <form id="Form1" method="post" runat="server">
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                <td>
                    <!--标题-->
                    <span class="txtPageTitle">新增用户信息</span></td>
                <td>
