<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CWOneChildQuery.aspx.cs" Inherits="CWXT.JHSY.CWOneChild.CWOneChildQuery" %>
...
<body class="common">
    <form id="Form1" method="post" runat="server">
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
            <!--工具条-->
            <tr>
                <td><span class="txtPageTitle">查询独生子女统计</span></td>
                <td>
