<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CWOneChildAdd.aspx.cs" Inherits="CWXT.JHSY.CWOneChild.CWOneChildAdd" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="uccs" TagName="CWOneChild" Src="CWOneChild.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head>
    <title>新增独生子女统计</title>
...
<body class="common">
    <form id="Form1" method="post" runat="server">
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                <td>
                    <span class="txtPageTitle">新增独生子女统计</span></td>
                <td>
