<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CWOneChildView.aspx.cs" Inherits="CWXT.JHSY.CWOneChild.CWOneChildView" %>
    ...
    <form id="Form1" method="post" runat="server">
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                <td>
                    <!--标题-->
                    <span class="txtPageTitle">查看独生子女统计</span></td>
                <td>
