<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CWFamilySpecHelpQuery.aspx.cs" Inherits="CWXT.JHSY.CWFamilySpecHelp.CWFamilySpecHelpQuery" %>
...
<body class="common">
    <form id="Form1" method="post" runat="server">
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
            <!--工具条-->
            <tr>
                <td><span class="txtPageTitle">查询计生家庭特别扶助统计</span></td>
                <td>
