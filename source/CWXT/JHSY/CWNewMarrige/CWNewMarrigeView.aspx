<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CWNewMarrigeView.aspx.cs" Inherits="CWXT.JHSY.CWNewMarrige.CWNewMarrigeView" %>
    ...
    <form id="Form1" method="post" runat="server">
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                <td>
                    <!--标题-->
                    <span class="txtPageTitle">查看新婚登记</span></td>
                <td>
