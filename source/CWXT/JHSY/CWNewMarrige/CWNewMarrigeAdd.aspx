<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CWNewMarrigeAdd.aspx.cs" Inherits="CWXT.JHSY.CWNewMarrige.CWNewMarrigeAdd" %>
...
<body class="common">
    <form id="Form1" method="post" runat="server">
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                <td>
                    <span class="txtPageTitle">新增新婚登记</span></td>
                <td>
