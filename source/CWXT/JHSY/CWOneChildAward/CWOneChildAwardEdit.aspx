<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CWOneChildAwardEdit.aspx.cs" Inherits="CWXT.JHSY.CWOneChildAward.CWOneChildAwardEdit" %>
...
<body class="common">
    <form id="Form1" method="post" runat="server">
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                <td>
                    <span class="txtPageTitle">编辑独生子女奖励费统计</span>
                </td>
                <td>
