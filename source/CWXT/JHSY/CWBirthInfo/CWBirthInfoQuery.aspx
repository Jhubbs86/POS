<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CWBirthInfoQuery.aspx.cs" Inherits="CWXT.JHSY.CWBirthInfo.CWBirthInfoQuery" %>
...
<body class="common">
    <form id="Form1" method="post" runat="server">
        <table cellspacing="0" cellpadding="0" width="100%" border="0">
            <!--工具条-->
            <tr>
                <td><span class="txtPageTitle">查询出生小孩信息</span></td>
                <td>
