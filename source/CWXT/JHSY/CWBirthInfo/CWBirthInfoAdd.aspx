<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CWBirthInfoAdd.aspx.cs" Inherits="CWXT.JHSY.CWBirthInfo.CWBirthInfoAdd" %>
...
<body class="common">
    <form id="Form1" method="post" runat="server">
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                <td>
                    <span class="txtPageTitle">新增出生小孩信息</span></td>
                <td>
