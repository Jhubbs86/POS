<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CWPerInfoAdd.aspx.cs" Inherits="CWXT.JHSY.CWPerInfo.CWPerInfoAdd" %>
<%@ Register TagPrefix="iewc" Namespace="Microsoft.Web.UI.WebControls" Assembly="Microsoft.Web.UI.WebControls" %>
<%@ Register TagPrefix="uccs" TagName="CWPerInfo" Src="CWPerInfo.ascx" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<html>
<head>
    <title>新增村务人员信息</title>
...
<body class="common">
    <form id="Form1" method="post" runat="server">
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                <td>
                    <span class="txtPageTitle">新增村务人员信息</span></td>
                <td>
