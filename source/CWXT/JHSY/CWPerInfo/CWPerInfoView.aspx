<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CWPerInfoView.aspx.cs" Inherits="CWXT.JHSY.CWPerInfo.CWPerInfoView" %>
    ...
    <form id="Form1" method="post" runat="server">
        <table cellpadding="0" cellspacing="0" border="0" width="100%">
            <tr>
                <td>
                    <!--标题-->
                    <span class="txtPageTitle">查看村务人员信息</span></td>
                <td>
