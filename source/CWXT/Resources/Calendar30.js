...
WebCalendar.darkColor = "Gray"; //控件的暗色 
WebCalendar.lightColor = "#F1F1F1"; //控件的亮色 
WebCalendar.btnBgColor = "#F1F1F1"; //控件的按钮背景色 
WebCalendar.wordColor = "#595959"; //控件的文字颜色 
WebCalendar.wordDark = "#C1C1C1"; //控件的暗文字颜色 
WebCalendar.dayBgColor = "#F1F1F1"; //日期数字背景色 
