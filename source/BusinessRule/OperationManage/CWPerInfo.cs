...
namespace BusinessRule.OperationManage
{
    /// <summary>
    /// 村务人员信息 
    /// </summary>
    public class CWPerInfo
    {
        /// <summary>
        /// 获取村务人员信息列表
        /// </summary>
        ...
        /// <returns>结果集</returns>
        public DataTable GetCWPerInfoList(out int totalCount, int pageSize, int pageIndex,
        ...
        /// <param name="subfilter">筛选条件对象</param>
        /// <returns>结果集</returns>
        public DataTable GetCWPerInfoListForExport(int pageSize, int pageIndex, BusinessFilter subfilter)
        {
            Wicresoft.Session.Session session = new Wicresoft.Session.Session();
            BusinessObjectCollection boc = new BusinessObjectCollection("CWPerInfo");
            boc.SessionInstance = session;
