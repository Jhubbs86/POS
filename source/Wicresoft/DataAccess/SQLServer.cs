...
namespace Wicresoft.DataAccess
{
	/// <summary>
	...
	public class SQLServer:IDataAccess
	{
		...
		public SQLServer()
		{
			...
			try
			{
                this.connectstring = System.Configuration.ConfigurationManager.AppSettings["ConnectionString"];
...
//			return this.ExecuteIdentity(this.Connection, commandType, CommandText);
		...
		public SqlDataReader ExecuteReader(string commandText,System.Data.CommandType commandType)
		{
		...
		public DataTable ExcuteDataTable(DataTable srcTable, string commandText, System.Data.CommandType commandType)
		{
